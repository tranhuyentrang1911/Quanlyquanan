 ...
 * @author Admin
 */
public class PNhanVien_DangNhap extends javax.swing.JPanel {

   
    public PNhanVien_DangNhap() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        add(jPanel3);
        jPanel3.setBounds(293, 192, 615, 238);
    ...
    private void btnDNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDNActionPerformed
       if(txtID.getText().length()> 0 && txtMK.getText().length()>0){
          ...
          TrangChu.nv=new NhanVienDao().login(txtID.getText(), txtMK.getText());
           if(TrangChu.nv!=null){
           JOptionPane.showMessageDialog(null, "Xin Chào "+TrangChu.nv.getTenNV(),
                  "Thông báo", JOptionPane.DEFAULT_OPTION);
           TrangChu.nvsanpham = new PNhanVien_QuanTri_HoaDon(TrangChu.nv);
            TrangChu.Xulydn.setBottomComponent(TrangChu.nvsanpham);
           }else{
